...
import type { ArbitrumLtipGranteeMetricsOperations } from "document-models/arbitrum-ltip-grantee/v1";

export const arbitrumLtipGranteeMetricsOperations: ArbitrumLtipGranteeMetricsOperations =
  {
