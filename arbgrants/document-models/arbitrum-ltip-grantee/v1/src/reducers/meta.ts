...
import type { ArbitrumLtipGranteeMetaOperations } from "document-models/arbitrum-ltip-grantee/v1";

export const arbitrumLtipGranteeMetaOperations: ArbitrumLtipGranteeMetaOperations =
  {
