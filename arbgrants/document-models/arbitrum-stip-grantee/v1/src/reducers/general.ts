...
import type { ArbitrumStipGranteeGeneralOperations } from "document-models/arbitrum-stip-grantee/v1";

export const arbitrumStipGranteeGeneralOperations: ArbitrumStipGranteeGeneralOperations =
  {
