...
import { useSelectedArbitrumLtipGranteeDocument } from "document-models/arbitrum-ltip-grantee";
...
export type IProps = {
  ...
  dispatch: DocumentDispatch<ArbitrumLtipGranteeAction>;
};
...
export default function Editor() {
  const [document, dispatch] = useSelectedArbitrumLtipGranteeDocument();
