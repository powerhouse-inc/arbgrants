...
import type { ArbitrumLtipGranteeState } from "document-models/arbitrum-ltip-grantee";
import { fromCommaDelimitedString } from "document-models/arbitrum-ltip-grantee";
import GranteeStats from "../GranteeStats.js";
...
const TabSummary = (props: TabSummaryProps) => {
  ...
  return (
    <div>
      ...
      <GranteeStats state={props} onOpenHistorical={props.onOpenHistorical} />
      <div className="mt-6">
