  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 pt-4">
      <div className="flex flex-col justify-start space-y-2 px-4">
        ...
        <div>
          ...
          <div>
            ...
            {distributionMechanismText.map((distribution, index) => (
              <div key={index}>
                <p>{distribution}</p>
              </div>
            ))}
        ...
        <div>
          <label className="text-xs font-medium text-gray-900">Changes</label>
          <p>{changes}</p>
        </div>
        <div>
          <label className="text-xs font-medium text-gray-900">
      ...
      <div className="flex flex-col justify-start space-y-2 px-4">
        ...
        <div>
          <label className="text-xs font-medium text-gray-900">Summary</label>
          <p>{actualsSummary}</p>
        </div>
      </div>
    </div>
