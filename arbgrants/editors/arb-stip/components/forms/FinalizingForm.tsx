...
import { classNames, intHandler } from "../../util.js";
...
type FinalizingFormProps = Pick<IProps, "dispatch"> & {
  phase: Phase;
  phaseIndex: number;
...
const FinalizingForm = (props: FinalizingFormProps) => {
  ...
  const [changesLocal, setChangesLocal] = useState(phase.stats?.changes || "");
  const [lessonsLocal, setLessonsLocal] = useState(phase.stats?.lessons || "");
