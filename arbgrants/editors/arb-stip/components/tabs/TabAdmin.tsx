...
import { Role } from "../UserProvider.js";
import { toArray } from "../../util.js";
import {
  addEditor,
  removeEditor,
} from "../../../../document-models/arbitrum-stip-grantee/v1/gen/creators.js";
...
const TabAdmin = (props: TabAdminProps) => {
  ...
  const editors = toArray<string>(props.document.state.global.editorAddresses);
