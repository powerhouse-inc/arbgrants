...
import { classNames, formatDate, toArray } from "../../util.js";
import type { Phase } from "document-models/arbitrum-stip-grantee";
import PhaseSummary from "../PhaseSummary.js";
import useIsEditor from "../../hooks/use-is-editor.js";
import EditPhaseForm from "../forms/EditPhaseForm.js";
            ...
            <table className="min-w-full divide-y divide-gray-300">
              ...
              <tbody className="divide-y divide-gray-200 bg-white">
                {phases.map((phase, phaseIndex) => {
                  ...
                  const isStatsValid = phase.status === "Finalized";
                  ...
                  return (
                    <tr
                      key={phaseIndex}
                      className={isPhaseInProgress ? "border-s-8" : ""}
                    >
                      ...
                      <td className="whitespace-nowrap px-3 py-5 text-sm text-gray-500">
                        <StatusBadge status={status} tooltip={statusTooltip} />
                      </td>
                      ...
                      <td className="relative whitespace-nowrap py-5 pl-3 text-right text-sm font-medium flex divide-x">
                        {isEditor && isPhaseStarted && (
                          <p
                            ...
                            onClick={() => onEdit(phase, phaseIndex)}
                          >
                            Edit
                          </p>
                        )}
